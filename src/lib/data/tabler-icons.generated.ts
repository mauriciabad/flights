...
//
// The 31 icons this app draws, and no others: Tabler ships 5130 and the rest
...
export const TABLER_ICON_PATHS = {
	/** the results filter-and-sort toggle */
	...
	/** ModeIcon and the ItineraryMap marker, the stopover night */
	bed: [
	...
	/** the flexible-dates link on the results page */
	'calendar-month': [
	...
	/** previous: an earlier month, an earlier photograph, back to the list */
	'chevron-left': [
		'M15 6l-6 6l6 6'
	],
	/** next: a later month, the next photograph */
	'chevron-right': [
		'M9 6l6 6l-6 6'
	],
	...
	/** SearchSummaryBar, edit this search */
	pencil: [
